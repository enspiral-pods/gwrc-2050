define([], function() {
  ...
  return {
    ...
    PATHWAY_ACTIONS: [
      ...
      { name: "Biogas power generation", categoryId: 2, typeId: 1, pathwayStringIndex: 5, tooltips: {
      ...
      { name: "Solar panels for electricity", categoryId: 2, typeId: 1, pathwayStringIndex: 6, tooltips: {
      ...
      { name: "Solar panels for hot water", categoryId: 2, typeId: 1, pathwayStringIndex: 7, tooltips: {
       ...
       { name: "Electricity imports from national grid", categoryId: 2, typeId: 1, pathwayStringIndex: 8, tooltips: {
       ...
       // Forestry 5
       { name: "Forestry", categoryId: 2, typeId: 1, pathwayStringIndex: 10, tooltips: {
       ...
       { name: "Livestock and their management", categoryId: 2, typeId: 1, pathwayStringIndex: 11, tooltips: {
       ...
       // Waste volumes  8
       { name: "Waste volumes", categoryId: 2, typeId: 1, pathwayStringIndex: 13, tooltips: {
       ...
       { name: "Waste volumes", categoryId: 2, typeId: 1, pathwayStringIndex: 14, tooltips: {
       ...
       { name: "Biomass supply", categoryId: 2, typeId: 1, pathwayStringIndex: 16, tooltips: {
       ...
       // Bomass supply 11
       { name: "Type of Fuel", categoryId: 2, typeId: 1, pathwayStringIndex: 17, tooltips: {
       ...
       // Travel Demand 13
       { name: "Travel Demand", categoryId: 1, typeId: 1, pathwayStringIndex: 20, tooltips: {
       ...
       // Public Transport 14
       { name: "Public Transport", categoryId: 1, typeId: 1, pathwayStringIndex: 21, tooltips: {
      ...
      // Active Transport 15
      { name: "Active Transport", categoryId: 1, typeId: 1, pathwayStringIndex: 22, tooltips: {
       ...
       { name: "Vehicle ocupancy", categoryId: 1, typeId: 1, pathwayStringIndex: 23, tooltips: {
      ...
      { name: "Electrification of light vehicles", categoryId: 1, typeId: 1, pathwayStringIndex: 24, tooltips: {
       ...
       { name: "Electrification of public transport", categoryId: 1, typeId: 1, pathwayStringIndex: 25, tooltips: {
        ...
        { name: "Vehicle fuel efficiencies", categoryId: 1, typeId: 1, pathwayStringIndex: 26, tooltips: {
         ...
         // Freight volume 21
         { name: "Freight volume", categoryId: 1, typeId: 1, pathwayStringIndex: 28, tooltips: {
          ...
          { name: "Mode and efficiency", categoryId: 1, typeId: 1, pathwayStringIndex: 29, tooltips: {
           ...
           { name: "Domestic aviation", categoryId: 1, typeId: 1, pathwayStringIndex: 30, tooltips: {
            ...
            { name: "Domestic navigation", categoryId: 1, typeId: 1, pathwayStringIndex: 31, tooltips: {
           ...
           { name: "Space and water heating demand", categoryId: 1, typeId: 1, pathwayStringIndex: 33, tooltips: {
          ...
          { name: "Heating technology", categoryId: 1, typeId: 1, pathwayStringIndex: 34, tooltips: {
          ...
          { name: "Home lighting & appliances", categoryId: 1, typeId: 1, pathwayStringIndex: 36, tooltips: {
          ...
          { name: "Electrification of home cooking", categoryId: 1, typeId: 1, pathwayStringIndex: 37, tooltips: {
          ...
          { name: "Growth in industry", categoryId: 1, typeId: 1, pathwayStringIndex: 39, tooltips: {
          ...
          { name: "Energy intensity of industry", categoryId: 1, typeId: 1, pathwayStringIndex: 40, tooltips: {
          ...
          { name: "Commercial demand for heating and cooling", categoryId: 1, typeId: 1, pathwayStringIndex: 42, tooltips: {
          ...
          { name: "Commercial heating electrification", categoryId: 1, typeId: 1, pathwayStringIndex: 43, tooltips: {
          ...
          { name: "Commercial lighting & appliances", categoryId: 1, typeId: 1, pathwayStringIndex: 45, tooltips: {
          ...
          { name: "Electrification of commercial cooking", categoryId: 1, typeId: 1, pathwayStringIndex: 46, tooltips: {
          ...
          { name: "Solvent & product use", categoryId: 1, typeId: 1, pathwayStringIndex: 47, tooltips: {
