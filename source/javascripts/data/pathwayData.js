define([], function() {
  ...
  return {
    ...
    PATHWAY_ACTIONS: [
      ...
      // Biogas power generation 0

      { name: "Solar panels for electricity", categoryId: 2, typeId: 1, pathwayStringIndex: 1, tooltips: {
      ...
      { name: "Solar panels for hot water", categoryId: 2, typeId: 1, pathwayStringIndex: 2, tooltips: {
       ...
       { name: "Electricity imports from national grid", categoryId: 2, typeId: 1, pathwayStringIndex: 3, tooltips: {
       ...
       // Forestry 5
       { name: "Forestry", categoryId: 2, typeId: 1, pathwayStringIndex: 5, tooltips: {
       ...
       // Travel Demand 13
       { name: "Travel Demand", categoryId: 1, typeId: 1, pathwayStringIndex: 13, tooltips: {
       ...
       // Public Transport 14
       { name: "Public Transport", categoryId: 1, typeId: 1, pathwayStringIndex: 14, tooltips: {
      ...
      // Active Transport 15
      { name: "Active Transport", categoryId: 1, typeId: 1, pathwayStringIndex: 15, tooltips: {
       ...
       // Vehicle ocupancy 16
       { name: "Vehicle ocupancy", categoryId: 1, typeId: 1, pathwayStringIndex: 16, tooltips: {
      ...
      { name: "Electrification of light vehicles", categoryId: 1, typeId: 1, pathwayStringIndex: 17, tooltips: {
       ...
       { name: "Electrification of public transport", categoryId: 1, typeId: 1, pathwayStringIndex: 18, tooltips: {
        ...
        { name: "Vehicle fuel efficiencies", categoryId: 1, typeId: 1, pathwayStringIndex: 19, tooltips: {
         ...
         // Freight volume 21
         { name: "Freight volume", categoryId: 1, typeId: 1, pathwayStringIndex: 21, tooltips: {
          ...
          { name: "Mode and efficiency", categoryId: 1, typeId: 1, pathwayStringIndex: 22, tooltips: {
           ...
           { name: "Domestic aviation", categoryId: 1, typeId: 1, pathwayStringIndex: 23, tooltips: {
            ...
            { name: "Domestic navigation", categoryId: 1, typeId: 1, pathwayStringIndex: 24, tooltips: {
           ...
           { name: "Space and water heating demand", categoryId: 1, typeId: 1, pathwayStringIndex: 26, tooltips: {
          ...
          { name: "Heating technology", categoryId: 1, typeId: 1, pathwayStringIndex: 27, tooltips: {
          ...
          { name: "Home lighting & appliances", categoryId: 1, typeId: 1, pathwayStringIndex: 29, tooltips: {
          ...
          { name: "Electrification of home cooking", categoryId: 1, typeId: 1, pathwayStringIndex: 30, tooltips: {
          ...
          { name: "Growth in industry", categoryId: 1, typeId: 1, pathwayStringIndex: 32, tooltips: {
          ...
          { name: "Energy intensity of industry", categoryId: 1, typeId: 1, pathwayStringIndex: 33, tooltips: {
          ...
          { name: "Commercial demand for heating and cooling", categoryId: 1, typeId: 1, pathwayStringIndex: 35, tooltips: {
          ...
          { name: "Commercial heating electrification", categoryId: 1, typeId: 1, pathwayStringIndex: 36, tooltips: {
          ...
          { name: "Commercial lighting & appliances", categoryId: 1, typeId: 1, pathwayStringIndex: 38, tooltips: {
          ...
          { name: "Electrification of commercial cooking", categoryId: 1, typeId: 1, pathwayStringIndex: 39, tooltips: {
          ...
          { name: "Solvent & product use", categoryId: 1, typeId: 1, pathwayStringIndex: 40, tooltips: {
